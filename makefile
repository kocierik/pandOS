...
kernel : phase1/asl.o phase1/pcb.o phase2/p2test.o phase2/exceptionHandler.o phase2/handlerFunction.o phase2/syscall.o phase2/scheduler.o crtso.o libumps.o phase2/main.o 
	$(LD) -o $@ $^ $(LDFLAGS)
